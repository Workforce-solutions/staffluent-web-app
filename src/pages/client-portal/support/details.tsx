...
import { useGetTicketDetailsQuery, useReplyToTicketMutation } from '@/services/clientTicketApi'
...
export default function TicketDetails() {
    ...
    // @ts-ignore
    const { data, isLoading } = useGetTicketDetailsQuery(Number(id))
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            {ticket?.related_to.service_request && (
                                <div className="flex items-center justify-between">
                                    <span className="text-sm text-muted-foreground">Service Request</span>
                            ...
                            >
                                ...
                                {msg.attachments && msg.attachments.length > 0 && (
                                    <div className="mt-2 flex items-center space-x-2">
                                        ...
                                        <span className="text-xs">{msg.attachments.length} attachments</span>
                                    </div>
                                )}
                            </div>
                        ))}
