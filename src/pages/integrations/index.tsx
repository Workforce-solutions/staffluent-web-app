...
const integrations = [
    { id: 1, name: 'Time Tracking App', status: 'active', lastSync: '2024-10-14 10:30:00' },
    { id: 2, name: 'Project Management Tool', status: 'active', lastSync: '2024-10-14 10:25:00' },
    { id: 3, name: 'Communication Platform', status: 'error', lastSync: '2024-10-13 15:45:00' },
    { id: 4, name: 'HR Management System', status: 'active', lastSync: '2024-10-14 09:50:00' },
    { id: 5, name: 'Customer Support Tool', status: 'inactive', lastSync: '2024-10-12 11:20:00' },
]
                                            ...
                                            <TableRow key={integration.id}>
                                                ...
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        className={integration.status === 'error' ? 'bg-red-500' : ''}
                                                    >
                                                        {integration.status}
                                                    </Badge>
                                                </TableCell>
