...
import { useGetCountriesQuery, useGetStatesQuery, useGetCitiesQuery } from '@/services/appConfigsApi'
...
export function AddClientModal({ open, setOpen }: AddClientModalProps) {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.address.country_id || !formData.address.state_id || !formData.address.city_id) {
      toast({
        title: 'Error',
  ...
  return (
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className='sm:max-w-[425px] md:min-w-[600px] max-h-[95vh] flex flex-col'>
          <DialogHeader>
            <DialogTitle>
          ...
          <div className="flex-1 overflow-y-auto pr-2">
                ...
                <div className='space-y-4'>
                  ...
                  <div className='grid gap-4'>
                    <div className='grid grid-cols-4 items-center gap-4'>
                      ...
                      <Select
                          value={formData.address.country_id ? formData.address.country_id.toString() : ''}
                    ...
                    {formData.address.country_id > 0 && (
                        <div className='grid grid-cols-4 items-center gap-4'>
                          ...
                          <Select
                              value={formData.address.state_id ? formData.address.state_id.toString() : ''}
                              onValueChange={(value) => setFormData({
                                ...formData,
                                address: {
                                  ...formData.address,
                    ...
                    {formData.address.state_id > 0 && (
                        <div className='grid grid-cols-4 items-center gap-4'>
                          ...
                          <Select
                              value={formData.address.city_id ? formData.address.city_id.toString() : ''}
                              onValueChange={(value) => setFormData({
                                ...formData,
                                address: {...formData.address, city_id: parseInt(value)}
                              })}
                          >
                            <SelectTrigger className='col-span-3'>
            ...
            <DialogFooter className="flex-none mt-6 flex justify-between sm:justify-end sm:space-x-2">
              <Button
                  type="button"
                  variant="outline"
