...
const auditLogs = [
    { id: 1, action: "User Login", user: "John Doe", timestamp: "2023-04-01 10:30:00", details: "Successful login from 192.168.1.1" },
    { id: 2, action: "Create Task", user: "Jane Smith", timestamp: "2023-04-01 11:45:00", details: "Created task 'Implement new feature'" },
    { id: 3, action: "Update User", user: "Admin", timestamp: "2023-04-01 14:20:00", details: "Updated user profile for 'John Doe'" },
        ...
        <Layout>
            ...
            <Layout.Body className='space-y-4'>
                ...
                <div className="space-y-4 md:space-y-0 md:flex md:items-center md:justify-between">
                    <div className="space-y-2 md:space-y-0 md:flex md:flex-1 md:items-center md:space-x-2">
                        <Input
