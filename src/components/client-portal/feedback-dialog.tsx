...
// @ts-ignore
export function FeedbackDialog({ open, setOpen, serviceId }) {
                                    ...
                                    <div className="flex space-x-2">
                                        {[1, 2, 3, 4, 5].map((rating) => (
                                            <Button
                                                ...
                                                type="button"
                                                variant="ghost"
                                                className={rating <= field.value ? "text-yellow-500" : ""}
                                                onClick={() => field.onChange(rating)}
                                            >
                                                <Star className="h-5 w-5" fill={rating <= field.value ? "currentColor" : "none"} />
                                            </Button>
                                        ))}
                                    </div>
                                    <FormMessage />
